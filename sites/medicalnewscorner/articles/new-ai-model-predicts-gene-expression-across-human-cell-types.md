...
description: >-
  Researchers from Dana-Farber Cancer Institute, The Broad Institute, Google,
  and Columbia University have developed EpiBERT, an AI model that predicts gene
  expression across human cell types by learning the relationship between DNA
...
reading_time: 2
source_url: >-
  https://medicalnewscorner.com/new-ai-model-predicts-gene-expression-across-human-cell-types/
imported_from: wordpress
wp_original_id: 24448
featuredImage: >-
  /assets/images/new-ai-model-predicts-gene-expression-across-human-cell-types.webp
seo:
  canonical: >-
    https://medicalnewscorner.com/new-ai-model-predicts-gene-expression-across-human-cell-types/
  og_title: >-
    New AI model predicts gene expression across human cell types - Medical News
    Corner
  og_description: >-
    Summary:&#xA0;A team of investigators from Dana-Farber Cancer Institute, The
    Broad Institute of MIT and Harvard, Google, and Columbia University have
    created an artificial intelligence model that can predict which genes are
    expressed in any type of human cell. The model, called EpiBERT, was inspired
    by BERT, a deep learning model designed to understand and generate
    [&hellip;]
...
quality_note: >-
  Well-written research article with strong factual accuracy and relevance, but
  significantly under target word count at only 400 words.
image_alt: >-
