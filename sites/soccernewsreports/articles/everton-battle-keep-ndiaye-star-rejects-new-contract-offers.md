---
title: Everton Battle to Keep Ndiaye as Star Rejects New Contract Offers
description: >-
  Everton faces a contract standoff with Iliman Ndiaye as the forward rejects
  multiple new deal offers while demanding an exit clause ahead of the summer
  window.
type: standard
status: published
...
tags:
  ...
  - Premier League
slug: everton-battle-keep-ndiaye-star-rejects-new-contract-offers
reviewer_notes: ''
source_url: >-
...
quality_note: >-
  While the article matches the site's tone and covers relevant keywords well,
