...
description: >-
  Request the full source article text to create a rewritten SEO-ready article
  about the best new TV shows premiering this summer.
type: standard
status: published
...
seo:
  ...
  og_description: >-
    Request the full source article text to create a rewritten SEO-ready,
    JSON-safe HTML article formatted for WordPress.
